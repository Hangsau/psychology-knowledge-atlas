# Source-first research programme

`targets.json` fixes the 48 research targets and distinguishes schools from traditions, theories, therapies, paradigms, subfields and models. It preserves legacy identity and order only; no legacy synthesis or verdict is research evidence.
