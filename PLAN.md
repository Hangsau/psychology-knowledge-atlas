...
目前 active gate 是 P2-SC。48項母表與來源包已建立，前31項已完成搜尋、槽位裁決與可取得來源稽核；下一項是 `cultural-historical-psychology`。已下載／正式書目或摘要頁只代表來源蒐集，不代表已讀全文、已驗證或可發布。原 P4-M1 已完成，不再是 active work。
