...
P1 已開始。APA CoA postdoctoral specialty practice areas、ANZSRC 2020 FoR Division 52 groups，以及 ANZSRC field-level 36/36 均已完成裁決。全球 applied-psychology 軸的 IAAP 18 個 active divisions 也已完成裁決。Indigenous contextual axis 已完整登錄 ANZSRC Division 45 的 20 個 groups，下一 gate 是裁決其中 19 個實質候選的 psychology relevance 與 entity boundaries。在明確宣告 coverage axes 前不進入 P2／P3 claims。
...
1. 完成目前 P1：裁決 ANZSRC Division 45 的 19 個實質 Indigenous studies groups，完成 Indigenous psychology 專屬軸。
