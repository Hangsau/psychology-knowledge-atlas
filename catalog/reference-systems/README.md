...
`anzsrc-2020-for-psychology-fields` 已完整登錄 Division 52 的 36 個 field codes。5201、5202 組已裁決；5203–5205 的 15 個實質 fields 保持 `pending`，NEC residual codes 則排除。報告中的 `complete:true` 只代表 36/36 都有 coverage record；在 pending 清零以前 `resolved:false`。
