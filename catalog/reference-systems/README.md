...
`anzsrc-2020-for-indigenous-studies-groups` 完整登錄並裁決 ANZSRC Division 45 的 20 個 group-level codes，保留 Aboriginal and Torres Strait Islander、Māori、Pacific Peoples，以及 Indigenous data／methodologies／global studies 的分立軸線。此 contextual inventory 不把 Indigenous psychology 縮減成健康或社會單一面向；19 個實質 groups 均以 `context_domain` 納入，不冒充心理學 `subfield`，`4599 Other Indigenous studies` residual 排除，因此 `complete:true`、`resolved:true`。Māori records 以 te reo Māori 為 canonical name、英文標籤為 alias；Pacific Peoples 的 `4517 society and community`／`4518 sciences` 依 2025-10-24 修正版 ABS data cube，而非舊 ARC guide 排列；4519 保留 Indigenous data、technologies、methodologies、global studies 與 people-specific exclusions，不把 Indigenous methodologies 當成一般西方研究方法的別名。
