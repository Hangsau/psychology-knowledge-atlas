...
completed_items:
  ...
  - mbct 的 P2-SC exit-gate 兩個空 covered 槽已實搜重裁並維持 covered：theory_methods 以 MacKenzie／Kocovski 2016 的MBCT理論方法專論與Batink等2013機制路徑全文補齊，clinical_outcomes 以Kuyken等2016復發預防IPD meta-analysis、Goldberg等2019當前憂鬱症狀meta-analysis及Williams等2014活性控制拆解試驗分開保留適應症、比較組、偏差／publication bias、既往發作與童年逆境邊界；Guilford 2013第二版表單因購書者個人使用及禁止再散布條款列excluded且未快取。2002／2013手冊版本不互換，MBCT不與MBSR、ACT、DBT、泛CBT加冥想、佛教修持、trait mindfulness、app／自助／教練／商業wellness混同，既有Goldberg 2021與Baer 2019明標為與mbsr共用出版物而非獨立MBCT證據；5筆新增本體跨包SHA-256零重複，mbct現有12筆retrieved本體＋1筆excluded指標
  - act 的 P2-SC exit-gate identity_history 覆蓋膨脹已修復並維持 covered：新增 Cullen 2008〈Acceptance and Commitment Therapy (ACT): A Third Wave Behaviour Therapy〉Cambridge Core 正式摘要／書目頁，係 Keele University／NHS 臨床主管的同儕審查學術文章而非 ACBS 機構自述或創始者自述，摘要直接記錄 ACT 發展史、contextualist／third-wave 定位及 RFT-to-ACT 關係；Cambridge 全文需購買／登入而未繞過，只保留878,767-byte官方摘要頁且明示非全文，CiteSeerX授權不明鏡像未採，泛CBT歷史PMC瀏覽端的reCAPTCHA殼未快取。RFT-only、泛third-wave CBT及DBT／MBCT／MBSR／REBT／constructivist-psychotherapy／cognitive-behavioral-therapy、商業教練／app／自助／培訓行銷皆不冒充ACT身分史；新增本體跨包SHA-256零重複，act現有7筆retrieved本體，全集累計421筆
  - constructivist-psychotherapy 的 P2-SC exit-gate empirical_status 覆蓋膨脹已修復並維持 covered：新增 University of York CRD／NCBI Bookshelf 的 Metcalfe、Winter與Viney 2007 PCT系統回顧之2009 DARE獨立critical abstract；其記錄27項研究（15 RCT、8項非隨機對照、4項重複量測），臨床樣本對無治療僅小效果（d=-0.34），對活性治療無顯著差異，並保留未正式品質評估、未預定結果、程序不明、異質性、隨機化／配置隱藏／流失／ITT及多數研究集中兩個研究群的限制，未把集中度偽造為未估計的allegiance效果。此來源只裁決Kelly衍生的personal construct psychotherapy，不替整個constructivist／constructionist家族、social constructionism、coherence／narrative therapy或其他獨立therapy targets背書；第三方Metcalfe出版社PDF帶具名Downloaded by浮水印及不得散布條款而未快取，Wiley Holland全文403且未繞過。新增51,110-byte HTML本體通過題名、內容、假殼與跨包SHA-256檢查，constructivist-psychotherapy現有7筆retrieved本體，全集累計422筆
...
repair_update_mbct: 2026-08-09 mbct 的theory_methods／clinical_outcomes兩個空 covered 槽均已補上合格本體；重跑後剩餘5項為 act:identity_history、constructivist-psychotherapy:empirical_status、rebt:empirical_status 三個空槽，以及 existential-psychology／transpersonal-psychology 的2份浮水印PDF，失敗清單已無mbct
repair_update_act: 2026-08-09 act:identity_history 已以 Cullen 2008 Cambridge Core 正式摘要／書目本體補齊並維持 covered；重跑後剩餘4項為 constructivist-psychotherapy:empirical_status、rebt:empirical_status 兩個空槽，以及 existential-psychology／transpersonal-psychology 的2份浮水印PDF，失敗清單已無act
repair_update_constructivist_psychotherapy: 2026-08-09 constructivist-psychotherapy:empirical_status 已以 University of York CRD／NCBI DARE 的PCT系統回顧獨立critical abstract補齊並維持 covered；重跑後剩餘3項為 rebt:empirical_status 空槽，以及 existential-psychology／transpersonal-psychology 的2份浮水印PDF，失敗清單已無constructivist-psychotherapy
repair_update_rebt: 2026-08-09 rebt:empirical_status 已以 NICE／NCBI Bookshelf 的RET對活性behaviour therapy evidence table及Gossette／O'Brien 1992正式PubMed摘要補齊並維持 covered；Stage 3現為347/347 covered槽均有retrieved item、全 corpus零失敗，整體gate僅餘Stage 7另外兩包的2份既有浮水印PDF
repair_update_rights_pdfs: 2026-08-09 existential-psychology與transpersonal-psychology兩份APA個人使用PDF均已刪除並改標excluded，分別由Terao／Satoh 2022與Kitson等2020的PMC CC BY完整XML替代；Stage 7現為零浮水印命中、Stage 3仍為347/347 covered槽均有retrieved item，P2-SC exit gate PASS（failure count 0），原14項finding全數resolved、目前無open finding
```
